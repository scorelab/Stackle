...
var strategy = new GithubStratergy({clientID: authConfig.clientId, clientSecret: authConfig.secret, callbackURL: authConfig.callback},
             function(token, refreshToken, profile, cb){
              ...
              UserModel.findOne({userId: currentUser.userId}).exec(function(err, data){
